...
export class WebPushNotificationsService {
  ...
  constructor(
    ...
    this.applicationServerPublicKey = 'BPMv7ncUxiT16PP18_yPPxG1A87sLjluUkz7mR7IidJUHWd7CmvLYI0TpWjLw6j0vkaVFq4ptLZ-AyymXeGxX10';
  }
  ...
  private enableServiceWorker(): void {
      if ('serviceWorker' in navigator && environment.production) {
        console.log("en el servis worker");
        navigator.serviceWorker.register('app/shared/servicios/alertaAyuda/serviceWorker/sw.js',{scope: '/app/shared/servicios/alertaAyuda/serviceWorker/'})
        .then( swReg => {
